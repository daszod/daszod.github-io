    ...
    <article className="bt bb b--black-10 shadow-4 pv2 mb5">
          <div className="flex flex-column flex-row-ns flex-column-m ph3-ns">
            ...
            <div className="w-100 w-50-l pr5-l center pv5-l h-50 pa1 tj">
              ...
              <button type="button" className="f6 br2 dim grow ba pv2 ph3 b--solid link pointer bg-light-silver"><a className="link white" href={webseite} target="_blank"  rel="noopener noreferrer" > Zur Webseite</a></button>
            </div>
          </div>
      </article>
